...
const videos = [
  "https://www.youtube.com/embed/mCUmaP4BonY",
  "https://www.youtube.com/embed/vc5KxnDl0zI",
  "https://www.youtube.com/embed/Zx1Cn_mD95U",
  "https://www.youtube.com/embed/Awjbs9pOXJE",
  "https://www.youtube.com/embed/jj3oWzPDKgE",
]

const videos2 =[
  "https://www.youtube.com/embed/lxDq0Lw3NDU",
  "https://www.youtube.com/embed/SxClE7--wnk",
  "https://www.youtube.com/embed/XusiY_MCnzM",
  "https://www.youtube.com/embed/Nma-BwAqLR0",
  "https://www.youtube.com/embed/y8B8NpeZauQ"
]
  ...
  return (
    <div className="home">
      ...
      <div className="features dark" dir="rtl">
          ...
          <div className="container  col-lg-12">
             <div className="row">
            <div className="item col-md-6 col-6">
            ...
            <div className="item col-md-6 col-6">
            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/4NMK_Ue4iOw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      ...
      <div className="features dark lg-12 col-md-12" dir="rtl" id="news">
...
<div className="row">
            ...
            <div className="item col-md-6 col-6 pt-5">
      ...
      <div className="features dark" dir="rtl" id="podcats">
         ...
         <div className="row">
              ...
              <div className="item col-12">
                <VideoCarousel videos={videos2}></VideoCarousel>
              </div>
            </div>
          </div>
        </div>
